...
{
	void  marry(){
		System.out.println("we should marry according to parent");
	}
}
...
{
	void  marry(){
		System.out.println("we should marry according to our decesion");
	}
}
class Child22 extends Parent22,Parent2
{
	void marry1(){
		marry();
	}
